...
void Ejercicio7(){
    ...
    cout<<"Ha introducido "<<contador-1<<" frases"<<endl;
}
...
void Ejercicio24(){
    ...
    for(int i=1;i<=numero;i++){
        if(numero%i==0){ //Si el numero es divisible entre i, contador aumenta en 1
            contador++; 
        }
    }
    if(contador==2){
...
void Ejercicio25(){
    ...
    cin>>numero;
    if(numero<5000){ //Comprobamos que el numero es menor de 5000
        while(numero>=1000){ //Comprobamos si el numero es mayor o igual que 1000
            cout<<"M";
            numero=numero-1000;
        }
        while(numero>=900){
