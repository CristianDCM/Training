...
void Txt(int n)
{
    ...
    switch (n){
    case 1:
        cout << "1.RUA que lea un número e imprima por pantalla si el número es mayor, igual o menor de 0." << endl;break;
    case 2:
        cout << "2.RUA que lea un número e imprima por pantalla si el número es par o impar." << endl;break;
    case 3:
